...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo("<form action='conf_prenotazioni_cibi.php' method='post'><input type='text' value='$orapren' name='orapren' hidden><input type='hidden' name='tavolo' value='$tavolo'><input type='text' name='listaid' value='$listaid' hidden><input type='hidden' name='tipo' value='tipici'><input type='submit' value='Conferma'></form>");
...
if ($querymenu_result->num_rows == 0) {
    ...
    while ($row_menu != null) {
        ...
        echo("<input type='hidden' name='id' id='$idi' value='$row_menu[idPiattiTipici]'>");
