...
if (!array_key_exists("HTTP_REFERER", $_SERVER)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $prezzo = $_POST['prezzo'];
        echo("Vuoi inserire davvero la pizza di nome $nome, descrizione $descrizione e prezzo $prezzo?");
        ?>
        <form action="conf_insert_pizze.php" method="post">
